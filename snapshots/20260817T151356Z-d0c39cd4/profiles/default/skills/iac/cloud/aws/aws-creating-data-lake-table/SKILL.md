---
name: aws-creating-data-lake-table
description: "Use when the task involves create data lake tables with amazon s3 tables in AWS. >-"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, glue, athena, data-lake]
    related_skills: [cloud-architect, aws-ingesting-into-data-lake, aws-querying-data-lake]
---
...
This skill covers create data lake tables with amazon s3 tables workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/storage-skills/creating-data-lake-table` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-creating-data-lake-table`.
