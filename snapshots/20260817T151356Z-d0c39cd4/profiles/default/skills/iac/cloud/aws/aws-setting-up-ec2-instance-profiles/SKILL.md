...
This skill covers setting up ec2 instance profiles workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/ec2-skills/setting-up-ec2-instance-profiles` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.
