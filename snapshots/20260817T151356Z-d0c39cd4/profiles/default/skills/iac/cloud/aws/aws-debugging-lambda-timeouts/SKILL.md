...
This skill covers debugging lambda timeouts workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/serverless-skills/debugging-lambda-timeouts` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.
