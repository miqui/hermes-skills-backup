...
This skill covers troubleshooting efs workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/storage-skills/troubleshooting-efs` into Hermes-native skill format for the local `iac` taxonomy.
