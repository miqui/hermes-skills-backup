...
description: "Use when the task involves billing and cost management in AWS. |"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, cost-optimization, budgets, pricing, finops]
    related_skills: [cloud-architect, aws-observability]
---
...
This skill covers billing and cost management workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-billing-and-cost-management` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-billing-and-cost-management`.
