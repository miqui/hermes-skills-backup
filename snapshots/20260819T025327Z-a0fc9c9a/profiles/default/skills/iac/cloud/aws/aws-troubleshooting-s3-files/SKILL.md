---
name: aws-troubleshooting-s3-files
description: "Use when the task involves troubleshooting s3 files in AWS. >"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, s3, storage, troubleshooting]
    related_skills: [cloud-architect, aws-securing-s3-buckets, aws-observability]
---
...
This skill covers troubleshooting s3 files workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/storage-skills/troubleshooting-s3-files` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-troubleshooting-s3-files`.
