...
This skill covers connecting vpcs with peering workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/networking-and-content-delivery-skills/connecting-vpcs-with-peering` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.
