...
This skill covers aws amplify gen2 workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-amplify` into Hermes-native skill format for the local `iac` taxonomy.
