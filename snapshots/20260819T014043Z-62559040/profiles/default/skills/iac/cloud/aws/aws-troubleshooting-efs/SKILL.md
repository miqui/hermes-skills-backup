---
name: aws-troubleshooting-efs
description: "Use when the task involves troubleshooting efs in AWS. >"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, efs, storage, troubleshooting]
...
This skill covers troubleshooting efs workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/storage-skills/troubleshooting-efs` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-troubleshooting-efs`.
