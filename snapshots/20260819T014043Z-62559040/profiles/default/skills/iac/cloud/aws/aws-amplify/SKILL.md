---
name: aws-amplify
description: "Use when the task involves aws amplify gen2 in AWS. >"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, frontend, backend, fullstack, appsync]
    related_skills: [cloud-architect, aws-cdk, aws-sdk-js-v3-usage]
---
...
This skill covers aws amplify gen2 workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-amplify` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-amplify`.
