...
7. Replaced template defaults with explicit region/model configuration, a caller-supplied pinned image digest, hash-locked dependencies, verified FastMCP 3.x HTTP/health configuration, and explicit custom-resource response-helper packaging guidance.
