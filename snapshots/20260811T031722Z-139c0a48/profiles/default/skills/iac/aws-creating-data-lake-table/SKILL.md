...
This skill covers create data lake tables with amazon s3 tables workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/storage-skills/creating-data-lake-table` into Hermes-native skill format for the local `iac` taxonomy.
