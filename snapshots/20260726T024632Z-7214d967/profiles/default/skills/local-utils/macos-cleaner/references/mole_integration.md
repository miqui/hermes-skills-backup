...
**IMPORTANT**: Mole requires a TTY (terminal) environment for interactive commands. When running Mole from automated environments (scripts, Hermes, CI/CD), use `tmux` to provide a proper TTY.
