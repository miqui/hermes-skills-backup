...
This skill covers aws exploring data catalog workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/exploring-data-catalog` into Hermes-native skill format for the local `iac` taxonomy.
