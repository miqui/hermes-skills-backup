...
This skill covers cloudformation workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-cloudformation` into Hermes-native skill format for the local `iac` taxonomy.
