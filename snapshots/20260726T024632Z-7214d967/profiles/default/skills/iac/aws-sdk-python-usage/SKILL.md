...
This skill covers aws sdk for python (boto3) workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-sdk-python-usage` into Hermes-native skill format for the local `iac` taxonomy.
