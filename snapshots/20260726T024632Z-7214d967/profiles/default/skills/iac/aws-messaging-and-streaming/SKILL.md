...
This skill covers aws messaging & streaming services workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-messaging-and-streaming` into Hermes-native skill format for the local `iac` taxonomy.
