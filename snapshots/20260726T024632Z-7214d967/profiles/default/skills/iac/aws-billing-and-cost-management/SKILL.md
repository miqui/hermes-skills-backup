...
This skill covers billing and cost management workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-billing-and-cost-management` into Hermes-native skill format for the local `iac` taxonomy.
