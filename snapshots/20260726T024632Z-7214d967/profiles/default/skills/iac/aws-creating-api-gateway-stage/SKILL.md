...
This skill covers creating an api gateway stage workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/serverless-skills/creating-api-gateway-stage` into Hermes-native skill format for the local `iac` taxonomy.
