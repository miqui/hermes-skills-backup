...
This skill covers aws securing s3 buckets workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/storage-skills/securing-s3-buckets` into Hermes-native skill format for the local `iac` taxonomy.
