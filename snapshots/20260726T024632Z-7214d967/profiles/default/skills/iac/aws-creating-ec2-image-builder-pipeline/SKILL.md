...
This skill covers creating an ec2 image builder pipeline workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/ec2-skills/creating-ec2-image-builder-pipeline` into Hermes-native skill format for the local `iac` taxonomy.
