...
This skill covers exporting rds/aurora to s3 workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/database-skills/exporting-rds-to-s3` into Hermes-native skill format for the local `iac` taxonomy.
