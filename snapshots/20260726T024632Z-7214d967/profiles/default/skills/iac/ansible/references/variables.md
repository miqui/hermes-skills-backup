...
# JSON
to_json_str: "{{ dict | to_json }}"
to_yaml_str: "{{ dict | to_yaml }}"
...
Prefer vault-backed files, environment-specific secret injection, or external secret systems over plain-text variables committed into source control.
