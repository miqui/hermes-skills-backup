...
This skill covers aws clean rooms workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/aws-cleanrooms` into Hermes-native skill format for the local `iac` taxonomy.
