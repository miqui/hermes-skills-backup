...
This skill covers aws sdk for swift workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-sdk-swift-usage` into Hermes-native skill format for the local `iac` taxonomy.
