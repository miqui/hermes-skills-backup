...
This skill covers query data lake workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/querying-data-lake` into Hermes-native skill format for the local `iac` taxonomy.
