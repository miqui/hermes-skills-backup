...
This skill covers troubleshooting s3 files workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/storage-skills/troubleshooting-s3-files` into Hermes-native skill format for the local `iac` taxonomy.
