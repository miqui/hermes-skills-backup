...
This skill covers aws iam — common pitfalls workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-iam` into Hermes-native skill format for the local `iac` taxonomy.
