...
This skill covers launching ec2 instances with best practices workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/ec2-skills/launching-ec2-instance-with-best-practices` into Hermes-native skill format for the local `iac` taxonomy.
