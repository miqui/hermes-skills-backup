...
This skill covers connect to data source workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/connecting-to-data-source` into Hermes-native skill format for the local `iac` taxonomy.
