...
This local skill was adapted from the upstream repository below and normalized for the Hermes local catalog.

**Upstream repository**: [github.com/viliawang-pm/ai-engineering-toolkit](https://github.com/viliawang-pm/ai-engineering-toolkit)
**Upstream license**: MIT

Do not use upstream `/skill install` flows or copy files into `~/.claude/skills/` from this local catalog. If you need to refresh this skill from upstream later, re-run a Hermes normalization pass before replacing the local version.
