...
The bundled [recommended .golangci.yml](../assets/.golangci.yml) enables a broad set of linters across these domains, organized as a practical default rather than an exhaustive policy for every repo.
