...
Every operation should declare its capability via `x-business-capability`. This is what enables capability-level governance, capability-level metrics, and capability-level access control. See `assets/extension-vocabulary.md`.
