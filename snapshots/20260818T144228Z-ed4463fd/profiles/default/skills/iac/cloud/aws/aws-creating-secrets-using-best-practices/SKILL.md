...
This skill covers creating secrets using best practices workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/security-and-identity-skills/creating-secrets-using-best-practices` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.
