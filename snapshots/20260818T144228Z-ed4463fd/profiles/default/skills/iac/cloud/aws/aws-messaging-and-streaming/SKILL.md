...
description: "Use when the task involves aws messaging & streaming services in AWS. >"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, sqs, sns, kinesis, streaming]
...
This skill covers aws messaging & streaming services workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-messaging-and-streaming` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-messaging-and-streaming`.
