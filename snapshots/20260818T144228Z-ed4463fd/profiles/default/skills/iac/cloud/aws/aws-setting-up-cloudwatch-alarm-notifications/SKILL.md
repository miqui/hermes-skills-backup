...
This skill covers setting up cloudwatch alarm notifications workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/operations-skills/setting-up-cloudwatch-alarm-notifications` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.
