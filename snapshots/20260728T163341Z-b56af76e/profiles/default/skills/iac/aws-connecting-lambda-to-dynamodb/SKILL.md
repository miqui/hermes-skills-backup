...
This skill covers connecting lambda to dynamodb workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/serverless-skills/connecting-lambda-to-dynamodb` into Hermes-native skill format for the local `iac` taxonomy.
