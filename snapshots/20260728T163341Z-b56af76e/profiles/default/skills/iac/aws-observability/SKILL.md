...
This skill covers aws observability workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-observability` into Hermes-native skill format for the local `iac` taxonomy.
