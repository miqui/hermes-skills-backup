---
name: aws-ingesting-into-data-lake
description: "Use when the task involves ingest into data lake in AWS. >-"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, glue, athena, ingestion]
    related_skills: [cloud-architect, aws-creating-data-lake-table, aws-querying-data-lake]
---
...
This skill covers ingest into data lake workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/ingesting-into-data-lake` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-ingesting-into-data-lake`.
