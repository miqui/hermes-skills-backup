...
This skill covers aws containers workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-containers` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-containers`.
