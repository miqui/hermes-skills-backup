...
This skill covers amazon bedrock workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/amazon-bedrock` into Hermes-native skill format for the local `iac` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `amazon-bedrock`.
