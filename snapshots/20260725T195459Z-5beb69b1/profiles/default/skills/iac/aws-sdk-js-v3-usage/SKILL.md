...
This skill covers aws sdk for javascript v3 workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-sdk-js-v3-usage` into Hermes-native skill format for the local `iac` taxonomy.
