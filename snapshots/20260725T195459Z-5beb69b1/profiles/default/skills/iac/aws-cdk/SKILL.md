...
This skill covers aws cdk workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-cdk` into Hermes-native skill format for the local `iac` taxonomy.
