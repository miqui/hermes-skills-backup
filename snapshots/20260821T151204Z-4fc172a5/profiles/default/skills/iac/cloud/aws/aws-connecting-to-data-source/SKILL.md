---
name: aws-connecting-to-data-source
description: "Use when the task involves connect to data source in AWS. >-"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, analytics, ingestion, connectors]
    related_skills: [cloud-architect, aws-ingesting-into-data-lake, aws-exploring-data-catalog]
---
...
This skill covers connect to data source workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/connecting-to-data-source` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-connecting-to-data-source`.
