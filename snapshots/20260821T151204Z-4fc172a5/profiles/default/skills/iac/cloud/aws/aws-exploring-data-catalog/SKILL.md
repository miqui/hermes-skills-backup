---
name: aws-exploring-data-catalog
description: "Use when the task involves aws exploring data catalog in AWS. >-"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, glue, catalog, analytics]
    related_skills: [cloud-architect, aws-finding-data-lake-assets, aws-querying-data-lake]
---
...
This skill covers aws exploring data catalog workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/exploring-data-catalog` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-exploring-data-catalog`.
