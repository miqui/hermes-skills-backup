---
name: aws-querying-data-lake
description: "Use when the task involves query data lake in AWS. >-"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, athena, queries, analytics]
    related_skills: [cloud-architect, aws-exploring-data-catalog, aws-creating-data-lake-table]
---
...
This skill covers query data lake workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/querying-data-lake` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-querying-data-lake`.
