...
This skill covers find data lake assets workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/analytics-skills/finding-data-lake-assets` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.
