...
description: "Use when the task involves aws sdk for javascript v3 in AWS. |"
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [aws, iac, sdk, javascript, typescript]
...
This skill covers aws sdk for javascript v3 workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-sdk-js-v3-usage` into Hermes-native skill format for the local `software-development` taxonomy.

## When to Use

- Use this skill when the task matches the AWS scope described by `aws-sdk-js-v3-usage`.
