...
This skill covers aws serverless workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/core-skills/aws-serverless` into Hermes-native skill format for the local `iac/cloud/aws` taxonomy.
