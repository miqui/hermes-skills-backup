...
This skill covers routing traffic with route 53 and cloudfront workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/networking-and-content-delivery-skills/routing-traffic-with-route53-and-cloudfront` into Hermes-native skill format for the local `iac` taxonomy.
