...
paths:
  # See assets/examples/flights-api-excerpt.md for a worked example of
  # collection/resource path structure and OAS 3.2-specific patterns.
  /TODO-resources:
    get:
...
components:
  # Pull in canonical pieces from the other local template references:
  #   - errors.md            → schemas.Problem, responses.*, examples.*
  #   - pagination.md        → parameters.PageSize, parameters.Cursor, schemas.PageMeta
  #   - common-parameters.md → IdempotencyKey, IfMatch, etc.
  #   - security-schemes.md  → oauthAuthCode, oauthDevice, bearerJwt, apiKey
  schemas: {}
  parameters: {}
  responses: {}
  examples: {}
