...
This skill covers enabling lambda vpc internet access workflows in AWS and was adapted from `aws/agent-toolkit-for-aws/specialized-skills/networking-and-content-delivery-skills/enabling-lambda-vpc-internet-access` into Hermes-native skill format for the local `iac` taxonomy.
